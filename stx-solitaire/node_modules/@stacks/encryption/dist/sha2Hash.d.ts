...
export declare function hashSha256Sync(data: Uint8Array): Uint8Array<ArrayBufferLike>;
export declare function hashSha512Sync(data: Uint8Array): Uint8Array<ArrayBufferLike>;
export {};
