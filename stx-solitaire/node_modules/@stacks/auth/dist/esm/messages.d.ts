...
export declare function makeAuthResponse(privateKey: string, profile: object | undefined, metadata: AuthMetadata | null, coreToken?: string | null, appPrivateKey?: string | null, expiresAt?: number, transitPublicKey?: string | null, hubUrl?: string | null, blockstackAPIUrl?: string | null, associationToken?: string | null, appPrivateKeyFromWalletSalt?: string | null): Promise<string>;
export {};
