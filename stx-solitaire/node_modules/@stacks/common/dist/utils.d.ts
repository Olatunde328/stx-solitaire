...
export declare function asciiToBytes(str: string): Uint8Array<ArrayBuffer>;
export declare function bytesToAscii(arr: Uint8Array): string;
export declare function octetsToBytes(numbers: number[]): Uint8Array<ArrayBuffer>;
export declare function concatBytes(...arrays: Uint8Array[]): Uint8Array;
export declare function concatArray(elements: (Uint8Array | number[] | number)[]): Uint8Array<ArrayBufferLike>;
